---
name: verifier
description: Reviews a KDLC item's evidence against its acceptance conditions after deterministic checks have already run. Use when an item is at verify or approve and a second reading is wanted before a human is asked to spend attention on it.
