...
| :- | :- | :- | :- |
| Account | `ACCOUNT-NNNN` | Portal engineering, via the CRM | Three Enterprise accounts are owed packs. |
...
`data/article-index.json` is generated by `project/index-build.py` and read by the help portal
