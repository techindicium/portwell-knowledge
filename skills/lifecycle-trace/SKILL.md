...
description: Trace one KDLC work item through the common delivery path, recording state and evidence at each stage. Use when an item enters the track, when it needs to advance, or when a reviewer asks where an item stands and why.
---
